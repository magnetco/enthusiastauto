...
<activation critical="MANDATORY">
  ...
  <step n="2">🚨 IMMEDIATE ACTION REQUIRED - BEFORE ANY OUTPUT:
      - Use Read tool to load /Users/heggiedesign/Development/enthusiastauto-1/bmad/bmm/config.yaml NOW
  ...
  <menu>
    ...
    <item cmd="*assess-project-ready" validate-workflow="/Users/heggiedesign/Development/enthusiastauto-1/bmad/bmm/workflows/3-solutioning/workflow.yaml">Validate if we are ready to kick off development</item>
